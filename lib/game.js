...
class Game {
	...
	handleClickHelp = (blockName) => {
		// const modalName = 'help-wire';
		const modalName = 'help-' + blockConfigs[blockName].type;
		console.log(modalName);
		if (blockName == 'conditional' || blockName == 'transistor') {
			this.showModal('conditionals');
		} else {
