...
class Game {
    constructor(configs) {
        ...
        $('.quiz-link').removeClass('invalid');
        $('.quiz-link[stageId="0"]').addClass('invalid');
    }
    ...
    openStage(stageId) {
      ...
      this.stage = new Stage(this.$stage, this.configs[stageId], this);
      $('.quiz-link').removeClass('invalid');
      $('.quiz-link[stageId="'+stageId+'"]').addClass('invalid');
    }
